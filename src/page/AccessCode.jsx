...
import { APIGetAccessCode, APIValidateCode } from "../api/axios";
...
export default function AccessCode() {
  ...
  const HandleValidateCode = async (values) => {
    ...
    APIValidateCode(state.phoneNumber, values.accessCode)
      .then((res) => {
        console.log(res);
        ...
        {isGetAccessCode ? (
          ...
          <p className="text-base mt-2">
            ...
            <span
              ...
              onClick={() => HandleLogin(state.phoneNumber)}
            >
              Send again
            </span>
          </p>
